...
class MediosTest extends DuskTestCase
{
    ...
    private $ruta_noticias = [
        "D:\mediospublicos" . "/" . "noticias_20220921.csv.gz",
        "D:\mediospublicos" . "/" . "noticias_fiscalia_20220921.csv.gz",
    ];

    private $ruta_implicados = [
        "D:\mediospublicos" . "/" . "implicados_20220921_sinAkasCortos.csv.gz",
        "D:\mediospublicos" . "/" . "implicados20220921_fiscalia_sinAkasCortos.csv.gz",
    ];
